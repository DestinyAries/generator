...
public class DefaultCommentGenerator implements CommentGenerator {
    ...
    /** If suppressDefaultComments is true, the default comment is ignored. */
    private boolean suppressDefaultComments;
    ...
    public void addComment(XmlElement xmlElement) {
        if (suppressAllComments || suppressDefaultComments) {
            return;
        }
    ...
    public void addConfigurationProperties(Properties properties) {
        ...
        suppressDefaultComments = isTrue(properties
                .getProperty(PropertyRegistry.COMMENT_GENERATOR_SUPPRESS_DEFAULT_COMMENTS));
    ...
    public void addClassComment(InnerClass innerClass,
        ...
        if (suppressDefaultComments) {
            innerClass.addJavaDocLine(introspectedTable.getFullyQualifiedTable().toString());
        } else {
            addDefaultClassComment(innerClass, introspectedTable.getFullyQualifiedTable());
        }
    ...
    public void addModelClassComment(TopLevelClass topLevelClass,
        ...
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
            ...
            for (String remarkLine : remarkLines) {
                topLevelClass.addJavaDocLine(new StringBuilder(" *   ")
                        .append(introspectedTable.getFullyQualifiedTable())
                        .append(": ").append(remarkLine).toString());  //$NON-NLS-1$
            }
        }
    ...
    public void addFieldComment(Field field,
        ...
        if (addRemarkComments && StringUtility.stringHasValue(remarks)) {
            ...
            String[] remarkLines = remarks.split(System.getProperty("line.separator"));  //$NON-NLS-1$
            for (String remarkLine : remarkLines) {
                field.addJavaDocLine(new StringBuilder(" *   ")
                        .append(introspectedTable.getFullyQualifiedTable())
    ...
    /**
     * generate default class comment
     * @param innerClass
     * @param fullyQualifiedTable
     */
    private void addDefaultClassComment(InnerClass innerClass, FullyQualifiedTable fullyQualifiedTable) {
        innerClass
                .addJavaDocLine(" * This class was generated by MyBatis Generator."); //$NON-NLS-1$
